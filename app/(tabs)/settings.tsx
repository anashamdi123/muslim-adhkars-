...
export default function SettingsScreen() {
  ...
  const themeOptions: Array<{ value: 'light' | 'dark'; label: string; icon: string }> = [
    { value: 'light', label: Localization.settings.themeLight, icon: 'light-mode' },
    { value: 'dark', label: Localization.settings.themeDark, icon: 'dark-mode' },
  ];
  ...
  return (
    <AnimatedScreen animationType="fade" duration={400}>
      <ThemedView style={styles.container}>
        <CommonHeader title={Localization.settings.title} />
        ...
        >
          ...
          >
            <View style={styles.modalHeader}>
              ...
              <ThemedText type="headline" size="medium" weight="bold" style={{ flex: 1, textAlign: 'right' }}>
                {Localization.settings.theme}
              </ThemedText>
            </View>
